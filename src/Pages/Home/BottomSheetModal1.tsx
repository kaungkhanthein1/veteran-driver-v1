...
export default function BottomSheetModal1({
  isExpanded,
  setIsExpanded,
  children,
  minHeight = 150,
  ...
  const [sheetHeight, setSheetHeight] = useState(300); // Initial height minus top bar height
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Handle bar */}
        <div className="w-12 h-1.5 bg-gray-400 rounded-full mx-auto mt-2 mb-4 cursor-grab active:cursor-grabbing" />
...
//   const sheetRef = useRef<HTMLDivElement>(null);
//   const contentRef = useRef<HTMLDivElement>(null);
//   const [sheetHeight, setSheetHeight] = useState(300); // Total available height
//   const [expandedHeight, setExpandedHeight] = useState(sheetHeight * 0.5); // 50% of screen height
//   const TOP_BAR_HEIGHT = 20;
//   const SHEET_MIN = minHeight;
//   const [isDragging, setIsDragging] = useState(false);
//   const [scrollStartY, setScrollStartY] = useState(0);
...
//   // Snap points
//   const variants = {
//     open: { y: sheetHeight - expandedHeight }, // Position for 50% height
//     closed: { y: sheetHeight - SHEET_MIN },
//   };
...
//       setSheetHeight(newHeight);
//       setExpandedHeight(newHeight * 0.5); // Update expanded height to be 50% of new height
//     };
//     updateHeight();
//     window.addEventListener("resize", updateHeight);
//     return () => window.removeEventListener("resize", updateHeight);
...
//     // If user drags up with enough velocity, expand the sheet to full height
//     if (info.velocity.y < -20) {
//       setIsExpanded(true);
//       return;
//     }
...
//     const expandedPosition = sheetHeight - expandedHeight;
//     const closedPosition = sheetHeight - SHEET_MIN;

//     // Calculate distances to each snap point
//     const distanceToExpanded = Math.abs(currentY - expandedPosition);
//     const distanceToClosed = Math.abs(currentY - closedPosition);

//     // Snap to the closest point
//     if (distanceToExpanded < distanceToClosed) {
//       setIsExpanded(true);
//     } else {
//       setIsExpanded(false);
//     }
...
//         style={{ height: sheetHeight }}
//         initial={expendable ? "closed" : "closed"}
//         animate={expendable ? (isExpanded ? "open" : "closed") : "closed"}
//         variants={variants}
//         transition={{
//           type: "spring",
//           damping: 30,
...
//         drag={expendable ? "y" : false}
//         dragConstraints={{
//           top: 0, // Fully expanded (100% height)
//           bottom: sheetHeight - SHEET_MIN, // Minimized
//         }}
//         dragElastic={0.1}
//         onDragStart={handleDragStart}
//         onDragEnd={handleDragEnd}
...
//             height: isExpanded
//               ? expandedHeight
//               : sheetHeight - (sheetHeight - SHEET_MIN),
//           }}
//         >
//           {children}
//         </motion.div>
