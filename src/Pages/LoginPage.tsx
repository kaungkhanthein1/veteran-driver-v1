...
export default function LoginPage({ onShowRegister, onClose }: LoginPageProps) {
  ...
  const handleRecaptchaExpired = () => {
    ...
    setRecaptchaError(
      t("loginPage.recaptchaExpired") || "reCAPTCHA expired. Please try again."
    );
  };
    ...
    <div className="dvh-fallback flex flex-col items-center bg-theme-primary px-4">
      <div className="w-full max-w-md mx-auto flex flex-col items-center">
        ...
        <form className="w-full space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          >
            {isVerifying
              ? t("loginPage.verifying") || "Verifying..."
        ...
        <div className="w-full mt-2 space-y-4">
          ...
          >
            ...
            <span>
              {isGoogleLoading
                ? t("loginPage.signingInWithGoogle") ||
