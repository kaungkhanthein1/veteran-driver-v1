    ...
    <div className="min-h-screen flex flex-col justify-between items-center bg-theme-primary px-4 py-8">
      <div className="w-full max-w-md mx-auto flex flex-col items-center">
        <div className="mt-8 mb-2 text-center">
          <h1 className="text-3xl font-bold text-theme-primary mb-2">{t('registerPage.title')}</h1>
          <p className="text-theme-secondary text-base">{t('registerPage.description')}</p>
        </div>
        <form className="w-full mt-8 space-y-6" onSubmit={e => { e.preventDefault(); navigate("/otp-verify"); }}>
          ...
          <div className="flex justify-center">
            <div className="bg-theme-secondary/30 rounded-lg px-4 py-3 flex items-center gap-2 w-full max-w-xs">
              ...
              <div className="ml-20 text-theme-secondary text-md">{t('registerPage.recaptchaLabel')}</div>
            </div>
          </div>
          <button
            type="submit"
