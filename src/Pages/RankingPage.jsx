...
export default function RankingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-theme-primary">
      {/* Header Section */}
      <div className="relative h-[150px] w-full sticky top-0 z-40" style={{ backgroundColor: '#271D00CC' }}>
        <img
          src={RankingHeader}
      ...
      <div className="w-full max-w-[480px] mx-auto flex flex-col flex-1 bg-theme-primary rounded-t-3xl z-20 pt-4">
        <div className="sticky top-0 bg-theme-primary z-30 pb-4">
          ...
          <div className="px-5 flex items-center space-x-2 mb-1 overflow-x-auto no-scrollbar py-5">
            ...
            <button className="p-2 flex-shrink-0">
              <svg className="w-6 h-6 text-theme-primary" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14 12l7.5-7.5 2.5 2.5L16.5 14l7.5 7.5-2.5 2.5L14 16.5l-7.5 7.5-2.5-2.5L10.5 14l-7.5-7.5 2.5-2.5L10.5 12z"/>
              </svg>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-5 space-y-4 pt-0">
