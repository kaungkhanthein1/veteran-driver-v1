...
import { regions } from '../ChooseLocationPage'; // Import regions data
import { mockCities } from '../../data/mockCities'; // Import mockCities data
...
const AddLocationPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    serviceType: '', // Add state for service type
    country: '', // Add state for country
    state: '', // Add state for state
  });
  ...
  const serviceTypeOptions = [
    { value: 'Massage', label: t('homePage.iconLabels.massage') },
    { value: 'Hotel', label: t('explore.categories.hotels') },
    { value: 'Bar', label: t('homePage.iconLabels.bar') },
      ...
      <div className="w-full max-w-[480px] flex flex-col">
        <div className="px-4 pt-4 pb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm mb-2">{t('addLocation.selectServiceType')}</label>
              <CustomDropdown
                name="serviceType"
                placeholder={t('addLocation.selectServiceTypePlaceholder')}
            ...
            <div className="flex gap-4">
              <div className="w-1/2">
                <label className="block text-sm mb-2">{t('addLocation.country')}</label>
                <CustomDropdown
                  name="country"
              ...
              <div className="w-1/2">
                <label className="block text-sm mb-2">{t('addLocation.state')}</label>
                <CustomDropdown
                  name="state"
            ...
            <button 
              ...
              onClick={() => navigate('/addMap', { state: { from: 'addLocation', formData } })}
            >
