...
const Topic = () => {
  ...
  return (
    <div className="w-full px-[14px] flex gap-[10px] overflow-x-auto">
      {posts.map((post) => (
        <div className="bg-theme-secondary min-w-[300px] border-b border-theme">
          {/* User Info Row */}
          <div className="flex items-center px-5 py-4">
            {post.user.avatar ? (
              ...
              <div className="w-[20px] h-[20px] rounded-full bg-theme-secondary flex items-center justify-center mr-3">
            ...
            <button className="ml-auto bg-theme-secondary text-[#FFC61B] rounded-full px-3 py-1.5 text-[7px] font-medium flex items-center">
              <svg
