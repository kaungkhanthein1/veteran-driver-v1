...
const TopNav = () => {
  ...
  return (
    <div className="px-[16px] py-[20px] flex justify-between w-full items-center bg-theme-secondary">
      ...
      <div className="flex gap-[12px]">
        <div onClick={() => navigate("/map")} className="bg-theme-primary rounded-full p-[12px]">
          <img 
            src={search} 
            alt="" 
        ...
        <div className="bg-theme-primary rounded-full p-[12px]">
          <img 
            src={map} 
            alt="" 
            className="[filter:var(--icon-filter)]"
